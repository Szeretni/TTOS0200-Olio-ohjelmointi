...
namespace L03_assignment07
{
    class L03_assignment07
    {
        static void Main(string[] args)
        {
            ...
            nightwish.SongList.Add(shudder);
            ...
            nightwish.SongList.Add(yours);
            //nightwish.SongList[numberOfSongs] = yours;
            //numberOfSongs++;

            //print infos
            printCdInfo(nightwish);
            foreach (ClassSongs s in nightwish.SongList)
            {
                printSongInfo(s);
            }
            Console.WriteLine();
